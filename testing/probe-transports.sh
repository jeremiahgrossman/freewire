...
declare -A PORT=( [wireguard]="UDP $WG" [udp443]="UDP $TLS" [http_connect]="gateway" [tls443]="TCP $TLS" [wss443]="TCP $TLS" [cdn_wss]="CDN 443" [dns_tcp]="TCP $DNS" [dns]="UDP $DNS" [icmp_udp]="UDP $ICMP" )
...
for t in wireguard udp443 http_connect tls443 wss443 cdn_wss dns_tcp dns icmp_udp; do
